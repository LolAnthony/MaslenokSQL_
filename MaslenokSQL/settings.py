"""
Django settings for MaslenokSQL project.
...
SECRET_KEY = 'django-insecure-x+790=*_r&z4wqhn!pq2jy3&-wee8w6_ghs!$a6vp_rf-l+3(b'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR / 'indexpages' / 'templates',
            BASE_DIR / 'storage' / 'templates',
            BASE_DIR / 'catalog' / 'templates',
            BASE_DIR / 'admin_menu' / 'templates',
            BASE_DIR / 'employee_auth' / 'templates',
            BASE_DIR / 'shop_auth' / 'templates',
        ]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
...
WSGI_APPLICATION = 'MaslenokSQL.wsgi.application'
